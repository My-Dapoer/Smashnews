...
class MainSlidePageAdapter(fa: FragmentActivity, private val list: List<Category> = emptyList()) : FragmentStateAdapter(fa) {

    override fun getItemCount(): Int = list.size

    override fun createFragment(position: Int): Fragment {
        return ListBeritaFragment.newInstance(list[position])
    }
}